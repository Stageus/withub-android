...
class ExpandableRVAdapter(private var rankingDataList: MutableList<ArrayList<RankData>>):RecyclerView.Adapter<ExpandableRVAdapter.ExpandableHolder>() {
    ...
    override fun onBindViewHolder(holder: ExpandableHolder, position: Int) {
        ...
        holder.apply {
            ...
            binding.cardViewTitle.text = itemView.resources.getStringArray(R.array.ranking_title)[position]
    ...
    inner class ExpandableHolder(val binding :RecyclerViewItemRankingBinding ):RecyclerView.ViewHolder(binding.root)
