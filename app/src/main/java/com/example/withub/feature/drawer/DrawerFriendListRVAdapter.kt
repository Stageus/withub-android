...
import com.example.withub.feature.friend.FriendActivity
...
class DrawerFriendListRVAdapter(val context : Context, val items : MutableList<FriendName>, val myData : MyNickNameData)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DrawerFriendListHolder {
    ...
    override fun onBindViewHolder(holder: DrawerFriendListHolder, position: Int) {
        holder.apply {
